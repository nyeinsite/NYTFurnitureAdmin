      ...
      <div class="row text-center">
        <table style="width:900px; height:500px; overflow-y:auto;background-color:white;"
          ...
          <tbody>
            ...
            <?php
$query="select * from orderfurniture";
$result = mysqli_query($con, $query);
while ($data = mysqli_fetch_array($result))
{
echo "<tr><td scope='row'>" . $data[0] . "</td><td scope='row'>" . $data[1] . "</td><td scope='row'>" . $data[5] . "</td><td scope='row'>" . $data[2] . "</td><td scope='row'>" . $data[11] . "</td>
<td scope='row'>" . $data[6] . "</td><td scope='row'>";
if($data[12]=='Pending')
echo "<a href='delivery.php?orderid=".$data[0]."'>Delivery</a></td></tr>";
else
